...
// Adapted from GKD's GkBlockCloseIcon.kt; original geometry and timing are retained.
// The playground card owns clicking, so this port only renders the icon.
@Composable
fun GkBlockCloseIcon(
    isClose: Boolean,
    modifier: Modifier = Modifier,
    contentDescription: String = if (isClose) "Close" else "Block",
